  ...
  return (
    <main className="relative w-full h-screen bg-[#F4F2EB] text-[#2c2820] font-retro-serif overflow-hidden selection:bg-[#E58B43] selection:text-white">
      ...
      <div 
        ...
        className={`w-full h-full overflow-x-auto overflow-y-hidden flex items-center px-12 md:px-32 gap-16 md:gap-32 relative z-20 ${isDragging ? "cursor-grabbing select-none" : "cursor-grab"}`}
      ...
      >
        ...
        <div className="w-[85vw] md:w-[70vw] lg:w-[60vw] shrink-0 flex flex-col justify-center h-full relative group">
          ...
          <h1 className="text-[5rem] md:text-[7rem] lg:text-[9rem] leading-[0.95] font-medium tracking-tight relative cursor-pointer z-10 w-max pointer-events-auto">
        ...
        <div className="w-[85vw] md:w-[60vw] lg:w-[55vw] shrink-0 flex flex-col justify-center h-full cursor-auto pointer-events-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-20 gap-y-16">
            <div className="border-l-[6px] border-[#D84B4B] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#D84B4B] text-[1.2rem] md:text-[1.4rem] font-bold mb-4">Bounty Pool</div>
              <div className="text-[3rem] md:text-[4rem] font-medium leading-none text-[#2c2820]">{comp.prizePool}</div>
            </div>
            <div className="border-l-[6px] border-[#4B7CD8] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#4B7CD8] text-[1.2rem] md:text-[1.4rem] font-bold mb-4">Sector</div>
              <div className="text-[3rem] md:text-[4rem] font-medium leading-none text-[#2c2820]">{comp.location}</div>
            </div>
            <div className="border-l-[6px] border-[#5C9E6D] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#5C9E6D] text-[1.2rem] md:text-[1.4rem] font-bold mb-4">Crew Size</div>
              <div className="text-[3rem] md:text-[4rem] font-medium leading-none text-[#2c2820]">{comp.teamSize}</div>
            </div>
            <div className="border-l-[6px] border-[#E2C151] pl-6 md:pl-8 pointer-events-none">
              <div className="uppercase tracking-widest text-[#E2C151] text-[1.2rem] md:text-[1.4rem] font-bold mb-4">Deploy Date</div>
              <div className="text-[3rem] md:text-[4rem] font-medium leading-none text-[#2c2820]">{comp.date}</div>
            </div>
          </div>
        </div>
        ...
        <div className="w-[90vw] md:w-[75vw] lg:w-[65vw] shrink-0 flex flex-col justify-center h-full mr-12 md:mr-24 pointer-events-auto cursor-auto">
          <div className="bg-[#EAE8E0] p-8 md:p-14 border-[6px] border-[#2c2820] shadow-[-10px_10px_0_rgba(44,40,32,1)] md:shadow-[-20px_20px_0_rgba(44,40,32,1)] relative max-h-[90vh] overflow-y-auto custom-scrollbar">
            ...
            <div className="flex flex-col items-center group relative cursor-pointer pt-8 border-t-2 border-[#2c2820] border-dashed">
              <h2 className="text-[2.5rem] md:text-[4.5rem] font-black uppercase text-center relative z-10 transition-transform group-hover:-translate-y-2 inline-block leading-none">
                 Ready to Execute?
              </h2>
              <span className="absolute text-[#D84B4B] -translate-x-2 translate-y-2 opacity-0 group-hover:opacity-100 z-0 transition-none animate-shatter mix-blend-multiply pointer-events-none text-center text-[2.5rem] md:text-[4.5rem] font-black uppercase leading-none" aria-hidden="true">Ready to Execute?</span>
              <button 
                onClick={(e) => {
                  if (isDragging) e.preventDefault();
                }}
                className="mt-8 px-8 md:px-12 py-3 md:py-5 border-[6px] border-[#2c2820] bg-[#F4F2EB] text-[#2c2820] font-bold text-[1.3rem] md:text-[1.8rem] uppercase tracking-widest hover:bg-[#2c2820] hover:text-[#F4F2EB] hover:shadow-[10px_10px_0_#D84B4B] transition-all flex items-center gap-4 group/btn z-10 active:translate-x-2 active:translate-y-2 active:shadow-none"
              >
